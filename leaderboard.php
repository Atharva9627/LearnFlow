...
$selected_quiz_title = $_GET['quiz_name'] ?? "Leaderboard";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <main class="main-content">
            <header class="top-bar">
                ...
                <div class="user-profile">
                    <span class="role-badge" style="background: var(--primary); padding: 2px 8px; border-radius: 4px; font-size: 0.7rem; margin-right: 10px; color: white;"><?= strtoupper($userRole) ?></span>
                ...
                <?php else: ?>
                    <div class="card">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; border-bottom: 1px solid var(--glass-border); padding-bottom: 20px;">
                            ...
                            <a href="leaderboard.php?class_id=<?= $current_class_id ?>" class="btn-view" style="text-decoration:none; display: flex; align-items: center; gap: 8px;">
                        ...
                        <div style="overflow-x: auto;">
                            <table class="leaderboard-table">
                                ...
                                <tbody>
                                    <?php
                                    // Make sure table names 'quiz_scores' and columns 'completed_at' match your DB
                                    $stmt = $conn->prepare("
